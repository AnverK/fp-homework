...
--------------------------------------------------------------------------------
-- Скорее всего, боян, но закончившим военку лишний раз грех не вспомнить


-- Дежурный по роте дневальному-духу:
-- - Генерал не приходил?
-- - Нет.
-- - Если придет, срочно сообщи мне!
-- И так несколько раз. В роту заходит генерал.
-- Дневальный:
-- - Ты что-ль генерал?
-- - Hу, я.
-- - Ты где, сука, ходишь!? Тебя сержант уже два часа ищет!
